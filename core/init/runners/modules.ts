...
import type { DenoHerderModule, IDenoHerder, ModuleResult } from '../../deno-herder.ts';

export class ModulesRunner implements IRunner {
  name = 'internal-modules';
  description = 'Run scripts with DenoHerder context';
  ...
  constructor(context: IDenoHerder) {
  ...
  async #loadModule(file: URL): Promise<DenoHerderModule | undefined> {
    try {
...
function isScript(value: unknown): value is DenoHerderModule {
